...
TARGET_BOOTLOADER_BOARD_NAME := p2
TARGET_CPU_SMP := true
TARGET_ARCH := arm
...
BOARD_BLUEDROID_VENDOR_CONF := device/lge/p2/bluetooth/vnd_lge_p2.txt

BOARD_HAS_NO_MISC_PARTITION := true

TARGET_RECOVERY_FSTAB = device/lge/p2/fstab.p2
...
BOARD_EGL_CFG := device/lge/p2/egl.cfg
...
TARGET_SPECIFIC_HEADER_PATH := device/lge/p2/include

BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/lge/p2/vibrator.c

COMMON_GLOBAL_CFLAGS += -DICS_CAMERA_BLOB  -DNEEDS_VECTORIMPL_SYMBOLS -DHAVE_FM_RADIO -DFORCE_SCREENSHOT_CPU_PATH


KERNEL_SGX_MODULES:
	make -C device/lge/p2/sgx-module/eurasia_km/eurasiacon/build/linux2/omap4430_android/ O=$(KERNEL_OUT) KERNELDIR=$(ANDROID_BUILD_TOP)/$(KERNEL_SRC) ARCH="arm" $(ARM_CROSS_COMPILE) KERNEL_CROSS_COMPILE=$(ARM_CROSS_COMPILE) TARGET_PRODUCT="blaze_tablet" BUILD=release TARGET_SGX=540 PLATFORM_VERSION=4.0
...
## Radio fixes
BOARD_RIL_CLASS := ../../../device/lge/p2/ril/

BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/p2/bluetooth
...
BOARD_HARDWARE_CLASS := device/lge/p2/cmhw/
